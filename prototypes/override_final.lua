...
if mods["space-age"] then
  for _, result in pairs(data.raw.recipe["scrap-recycling"].results) do
    if result.name == "iron-gear-wheel" then
      result.name = "iron-gear-wheel-rusty"
    end

    if result.name == "iron-stick" then
      result.name = "iron-stick-rusty"
    end

    if result.name == "iron-plate" then
      result.name = "iron-plate-rusty"
    end

    if result.name == "engine-unit" then
      result.name = "engine-unit-rusty"
    end
  end
...
-- 			if effect.type == "unlock-recipe" and effect.recipe == "engine-unit-derusting" then
